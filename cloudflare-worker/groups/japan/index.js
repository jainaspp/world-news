...
const FEEDS = [
    ...
    { name: 'Asahi Intl', url: 'https://www.asahi.com/rss/asahi/international.rdf', region: 'JPN', lang: 'ja' },
    { name: 'Asahi Tech', url: 'https://www.asahi.com/rss/asahi/tech_science.rdf', region: 'JPN', lang: 'ja' },
...
export default {
    ...
    async fetch(request) {
        return new Response(JSON.stringify({ status: 'ok', group: 'japan', feeds: FEEDS.length }), {
