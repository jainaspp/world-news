/**
 * Worker: Science (15 feeds) -> Supabase
 * Cron: */5 * * * *  (every 5 min)
 */
...
const FEEDS = [
    { name: 'Science Mag', url: 'https://www.science.org/rss/current.xml', region: 'SCI', lang: 'en' },
    ...
    { name: 'Popular Sci', url: 'https://www.popsci.com/arcio/rss/', region: 'SCI', lang: 'en' },
    ...
    { name: 'Reuters Biz', url: 'https://feeds.reuters.com/reuters/businessNews', region: 'BUS', lang: 'en' },
    { name: 'Fox Markets', url: 'https://moxie.foxbusiness.com/google-publisher/markets.xml', region: 'BUS', lang: 'en' },
    { name: 'NPR Health', url: 'https://feeds.npr.org/1128/rss.xml', region: 'HLT', lang: 'en' },
    { name: 'NHS England', url: 'https://www.england.nhs.uk/feed/', region: 'HLT', lang: 'en' },
    { name: 'Real Food', url: 'https://runningonrealfood.com/feed/', region: 'HLT', lang: 'en' },
    { name: 'Mark\'s Daily', url: 'https://feeds2.feedburner.com/MarksDailyApple', region: 'HLT', lang: 'en' },
    { name: 'CN Traveler', url: 'https://www.cntraveler.com/feed/rss', region: 'TRV', lang: 'en' },
...
export default {
    async scheduled(controller, env, ctx) {
        const t0 = Date.now();
        console.log('START [science] ' + FEEDS.length + ' feeds');
        ...
        console.log('DONE [science] +' + result.total + ' | ' + result.errors + ' errors | ' + (Date.now()-t0) + 'ms');
    },

    async fetch(request) {
        return new Response(JSON.stringify({ status: 'ok', group: 'science', feeds: FEEDS.length }), {
